...
ActiveRecord::Schema.define(:version => 20130416012567) do
  ...
  create_table "refinery_help_requests", :force => true do |t|
    t.string   "title"
    t.text     "description"
    t.string   "contact"
    t.datetime "expires"
  ...
  create_table "refinery_item_requests", :force => true do |t|
    t.string   "title"
    t.text     "description"
    t.string   "contact"
    t.datetime "expires"
